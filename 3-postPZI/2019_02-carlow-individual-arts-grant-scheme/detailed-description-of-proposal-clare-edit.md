...
My name is Colm O'Neill I and am a media artist, graphic designer, educator, web developer and researcher. I moved to Carlow from Brussels, Belgium in January 2019. I am applying for the individual arts grant to self-build an automated drawing and drafting machine called a *pen plotter*. 

## What is a pen plotter?

A pen plotter is a type of computer that prints vector graphics. This type of printer was the norm before the more commonplace ink-jet cartridge printers replaced them. Pen plotters differ from ink-jets as they are ---only able to draw lines (using pens, pencils or the like) instead of spreading ink to fill areas. With that simple difference between lines and areas, there is a link to be made to the difference between vector (line) based graphics and raster (pixel based) images. This distinction is fundamental to the history of computer graphics, and remains key for any screen display and graphics practice today, albeit a bit hidden.
...
international collaborators in irish setting with a view to working with other artists and facilitating workshops
...
I received a BA in Design and Communication and an MA in Media Desi... I am part of a research collective focused on Open Source graphic design and publication called Open Source Publishing<sup> 0</sup>.  )
