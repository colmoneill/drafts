...
<br>I'm interested in the relation between the employed mode of address and if / how it enables deeper or alternate understandings of a particular subject matter. My hypothesis is that different modes of address have a great influence on the access to and engagement with knowledge relative to its subject matter. This theory is the foundation for my project, which I will apply more specifically to the realm of visual production software.
...
![cultures_graph](../images/modes-of-address-culture-sequence.png)
...
<br>Some of this can be altered. Parts of this can be balanced back out, changed so that they speak more clearly and make more links to where the practices came from. They could also have a tone that encourages more testing and using for discovery than using for producing.
...
![tracks_graph](../images/modes-of-address-research-tracks.png)
